...
{ // begin pseudo code
   // allocate a stack (via malloc) of a certain size (choose 8192)
    ...
    init_TCB (tcb,function, stackP, 8192); //initializes tcb was the function sent in as the process it runs
    AddQueue(&RunQ, tcb);
...
//starts the program off by switching from a dummy to the head of the queue
void run()
{   // real code
